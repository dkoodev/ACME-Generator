...
class ProductStage2 extends React.Component {
  constructor(){
    super();
  }
  ...
  imageLoaded(e){
    if (this.props.qrcodeAPIContext.qrcodeInfo.userUploadedImageUrl != "") {
      this.props.qrcodeAPIContext.updateTag('userUploadedImage', this.props.qrcodeAPIContext.qrcodeInfo.userUploadedImageUrl, false, true, true, 101);
      setTimeout(() => {
        this.props.qrcodeAPIContext.updateTag('userUploadedImage', this.props.qrcodeAPIContext.qrcodeInfo.userUploadedImageUrl, false, false, false, 101);
      }, 500);
    }
  }
  ...
  render() {
    ...
    return (
      <div id="ProductStage2" className="columns" >
          <div id="qrcode-container-wrapper" className="column">
            <div id="qrcode-container" className={"box "} >
              <div className={"transparentBackground"}>
                <img onLoad={this.imageLoaded.bind(this)} onError={this.reloadComponent.bind(this)} src={frameUrl} style={{width:"100%",height:"100%", margin:"auto"}} />
              </div>
            </div>
          </div>
